...
def get_about_message() -> str:
    ...
    return (
        ...
        "\n"
        "Fitur:\n"
        "- Otomatis menyelesaikan verifikasi pelajar/guru/military SheerID\n"
        "- Mendukung verifikasi Gemini One Pro, ChatGPT Teacher K12, Spotify Student, Bolt.new Teacher, ChatGPT Military\n"
        "\n"
        "Cara Penggunaan:\n"
...
def get_help_message(is_admin: bool = False) -> str:
    ...
    msg = (
        ...
        f"/verify5 <link> - Verifikasi ChatGPT Military (-{VERIFY_COST} token)\n"
