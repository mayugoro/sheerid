"""Modul generator kartu pelajar PNG - Penn State LionPATH"""
import random
...
def generate_image(first_name, last_name, school_id='2565'):
    ...
    try:
        ...
        # Gunakan Playwright untuk screenshot (menggantikan Selenium)
        with sync_playwright() as p:
            browser = p.chromium.launch(headless=True)
            page = browser.new_page(viewport={'width': 1200, 'height': 900})
            page.set_content(html_content, wait_until='load')
            page.wait_for_timeout(500)  # Tunggu loading style
...
if __name__ == '__main__':
    ...
    print("Testing generate gambar PSU...")
    ...
    try:
        ...
        # Simpan gambar testing
        with open('test_psu_card.png', 'wb') as f:
            f.write(img_data)

        print(f"✓ Generate gambar berhasil! Ukuran: {len(img_data)} bytes")
