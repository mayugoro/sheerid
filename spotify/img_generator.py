"""Modul generate PNG kartu mahasiswa - Penn State LionPATH"""
import random
...
def generate_psu_id():
    """Generate PSU ID random (9 digit angka)"""
...
def generate_image(first_name, last_name, school_id='2565'):
    ...
    try:
        ...
        # Gunakan Playwright untuk screenshot (pengganti Selenium)
...
if __name__ == '__main__':
    ...
    # Fix masalah encoding console Windows
    if sys.platform == 'win32':
        sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')

    print("Test generate gambar PSU...")
    ...
    try:
        ...
        print(f"✓ Berhasil generate gambar! Ukuran: {len(img_data)} bytes")
        print("✓ Sudah disimpan sebagai test_psu_card.png")
